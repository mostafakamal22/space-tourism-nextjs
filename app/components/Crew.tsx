...
function Crew() {
  ...
  return (
    <div className="min-h-[100vh] flex justify-center items-center py-[15vh] laptop:py-0 px-3 overflow-hidden   bg-no-repeat bg-cover bg-center bg-crew-mobile tablet:bg-crew-tablet laptop:bg-crew-desktop">
      <main className="w-full min-h-[85vh] flex justify-center items-center text-center text-lighting laptop:min-h-[100vh] laptop:text-left laptop:pt-[14rem]">
        <section className="self-start h-[100%] w-[100%] max-w-[130rem] mx-[3rem] flex flex-col items-center tablet:p-[3rem] tablet:pb-0 pre-laptop:grid pre-laptop:grid-cols-[1fr_1fr] pre-laptop:grid-rows-[.25fr_.75fr] pre-laptop:gap-4 laptop:mx-[4rem]">
