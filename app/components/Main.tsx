...
export default function Main() {
  return (
    <div className="min-h-[100vh] font-Barlow  bg-no-repeat bg-cover bg-center bg-home-mobile tablet:bg-home-tablet laptop:bg-home-desktop">
      <main className="min-h-[85vh] flex justify-center items-center text-center text-lighting laptop:min-h-[100vh] laptop:pt-[14rem] laptop:text-left">
        <section className="h-[100%] w-[100%] max-w-[120rem] mx-[3rem] flex flex-col items-center tablet:p-[3rem] pre-laptop:flex-row latop:space-between laptop:items-end laptop:mx-[4rem]">
